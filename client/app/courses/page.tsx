            ...
            {isLoading ? (
                ...
                <>
                    ...
                    <div
                        ...
                        <Heading
                            title="All Courses - Learniverse"
                            description="Learniverse is a programming community."
                            keywords={"programming community, coding skills, expert insights, growth"}
                        />
                        <br />
                        ...
                        <br /><br />
                        <div className="grid grid-cols-1 gap-[20px] md:grid-cols-2 md:gap-[25px] lg:grid-cols-3 lg:gap-[25px] 1500px:grid-cols-4 1500px:gap-[35px] mb-12 bottom-0">
                            {courses &&
